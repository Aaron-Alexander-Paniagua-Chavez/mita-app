...
class MensajeMITA(str, Enum):
    ...
    USUARIO_NO_ENCONTRADO = "No encontramos ese correo o nombre. Revísalo e inténtalo de nuevo."
    CONTRASENA_INCORRECTA = "La contraseña no coincide. Revísala e inténtalo de nuevo."
    ROL_INCORRECTO = "La cuenta existe, pero corresponde a otro tipo de acceso."
